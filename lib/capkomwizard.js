...
(function() {
  ...
  jQuery.widget("Capkom.sizedetect", {
    ...
    _create: function() {
      ...
      this.element.append("<button class='catchme'>" + this.options.symbolLabel + "</button>");
    ...
    _newLevel: function(level) {
      ...
      if (this.size < this.options.minSize) {
        return this.message("Fertig!", function() {
          return _this.finish();
        });
      } else {
        return this.message("Sehr gut, nächstes Level", function() {
          this.level = level;
  ...
  Capkom.updateTTS = function() {
    if (Capkom.uiLoaded) {
      return jQuery(".tts").ttswidget({
        ...
        disabled: !Capkom.profile.get("useAudio")
      });
    } else {
