...
(function() {
  ...
  */
  ...
  Capkom.saveTestData = function(doc) {
    ...
    db.info({
      ...
      error: function(jqXhr, message) {
        return Capkom.console.error("couchdb info error: " + message);
      }
    });
    save = function() {
      return db.saveDoc(doc.toJSON(), {
        ...
        error: function(jqXhr, message) {
          return Capkom.console.error("saveDoc error: " + message);
        }
      });
    };
    if (doc.get('_id')) {
  ...
  Capkom.allStagesFinished = function() {
    return Capkom.profile.get('read') && Capkom.profile.get('symbolunderstanding') && Capkom.profile.get('symbolsizedetectDetails');
  };
