...
(function() {
  var Capkom, Stat, StopWatch, loadSymbolset, _base, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
  ...
  jQuery.widget("Capkom.sizedetect", {
    ...
    _create: function() {
      ...
      this.element.css({
        width: this.getInnerWidth() - 30,
        height: this.getInnerHeight() - 30
      });
  ...
  jQuery.widget("capkom.fontsize", {
    ...
    _create: function() {
      var i, _i, _ref2, _ref3,
        _this = this;
      this.element.addClass(this.options.styleClass);
      for (i = _i = _ref2 = this.options.min, _ref3 = this.options.max; _ref2 <= _ref3 ? _i <= _ref3 : _i >= _ref3; i = _ref2 <= _ref3 ? ++_i : --_i) {
    ...
    _setValue: function(val) {
      ...
      if ((_ref2 = this.buttonset) != null) {
        _ref2.buttonset('refresh');
      }
  ...
  */
  ...
  Capkom._oneDone = function() {
    var once, stillWaiting, _i, _len, _ref4, _results;
    ...
    */
    ...
    "symbolsize": {
      ...
      script: function(element) {
        ...
        buttonset.buttonset('widget').find('label').css({
          width: "160px",
          height: "140px"
        });
  ...
  */
  ...
  Capkom.showStages = function(el) {
    var an, anchor, anchorName, anchorNames, anchors, i, stage, stageNames, stages, _i, _j, _k, _len, _len1, _ref6, _ref7, _results, _results1;
    if (Capkom.uiLoaded) {
