...
(function() {
  var Capkom, Stat, StopWatch, loadSymbolset, _base, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    _this = this;
  ...
  jQuery.widget("capkom.ttswidget", {
    ...
    _getText: function() {
      ...
      if (this.element.text()) {
        return jQuery.trim(this.element.not(this.button).text().replace("" + this.options.buttonLabel, ""));
      }
    ...
    preset: function(lang, gender) {
      ...
      presets = {
        "de-male": ["LOCALE=de", "VOICE=bits3-hsmm"],
  ...
  jQuery.widget("Capkom.sizedetect", {
    ...
    _destroy: function() {
      ...
      jQuery('body').unbind('keyup', this._escHandler);
      this.element.unbind('click');
      return clearTimeout(this.timeoutTimer);
    },
    _beginGame: function() {
      var level;
      level = 2;
    ...
    _newLevel: function(level) {
      ...
      if (this.size < this.options.minSize) {
        ...
        this.currentLevel = [];
        lastLevelResults = this.details[this.size.toString()] = {};
    ...
    _attempt: function(succeeded) {
      ...
      if (this.currentLevel.length >= this.options.clickCount) {
        ...
        if (this.lastLevelResults.score > 0.5) {
    ...
    finish: function() {
      ...
      return _.defer(function() {
        return jQuery(_this.element).sizedetect('destroy');
      });
    },
    evaluateCurrentLevel: function() {
      ...
      this.lastLevelResults = this.details[this.size] = {
      ...
      return this.console.info('level finished', this.level, this.lastLevelResults);
    },
  ...
  Stat = (function() {
    ...
    Stat.prototype.getSamples = function() {
      var res;
      if (this.options.dropMargins && this._values.length >= 5) {
  ...
  jQuery.widget("Capkom.wordmatch", {
    ...
    _beginGame: function() {
      ...
      this._renderNext();
      this.fullgameTimer = new StopWatch(this.console.error);
      return this.fullgameTimer.start();
    },
    ...
    message: function(msg, cb, styleClass) {
      ...
      this.messageArea.css({
        'text-align': 'center'
      });
      this.messageArea.html("<div style='text-align:center;'>" + msg + "</div>").dialog({
        hide: "fade",
        close: function() {
          return _.defer(function() {
    ...
    finish: function() {
      ...
      this.results.fullTime = this.fullgameTimer.end();
  ...
  jQuery.widget("Capkom.capkomSymbol", {
    ...
    _create: function() {
      var _base, _profileChange, _ref4,
        _this = this;
      if (window.console) {
        this.console = window.console;
      } else {
      ...
      if ((_ref4 = (_base = this.options).symbolSets) == null) {
    ...
    _getSymbolUri: function(profile, sets) {
      ...
      if (!symbolSet) {
        this.console.error("No symbolset found for " + this.symbolId);
        return "";
      }
  ...
  jQuery.widget("capkom.fontsize", {
    ...
    _create: function() {
      ...
      return this.buttonset = jQuery(this.element).ultButtonset({
  ...
  if ((_ref5 = Capkom.symbolSets) == null) {
    Capkom.symbolSets = {};
  }

  if ((_ref6 = (_base = Capkom.symbolSets).sets) == null) {
    _base.sets = [];
  }
  ...
  */
  ...
  if ((_ref8 = Capkom._once) == null) {
    Capkom._once = [];
  }

  Capkom._oneDone = function() {
    var once, stillWaiting, _i, _len, _ref9, _results;
  ...
  Capkom.getTTSOptions = function() {
    return {
      ...
      prerecorded: {
        "Hallo im Online-Atelier! Ich helfe dir damit du das Online-Atelier gut verwenden kannst. Lass uns zuerst spielen!": "welcome.mp3",
        "Wenn du jetzt spielen willst, dann benütze den Weiter-Knopf um anzufangen": 'erklaerung1.mp3',
        "Wenn du nicht willst das dir der Text vorgelesen wird, dann drücke diesen Knopf. Du kannst diesen Knopf auch später wieder einschalten. Wenn du den Ton eingeschaltet hast ist der Knopf rot umrandet.": 'erklaerung2.mp3',
        "Wenn du nun spielen willst, dann benütze den Start Knopf um anzufangen": 'erklaerung3.mp3',
        "Wir beginnen mit einem Spiel: Füttere den Hund. Das Füttern geht so: Klicke mit der linken Maus-Taste auf den Hund. Wenn du es oft schaffst, ist der Hund glücklich und gesund.": 'symbolsize.mp3',
        "Wenn du später noch einmal spielen willst, dann drücke den Zurück Knopf": 'erklaerung4.mp3',
        "Finde heraus welche Bilder zusammengehören. Zu dem Bild in der ersten Reihe passt immer ein Bild aus der zweiten Reihe. Klicke das richtige Bild an!": 'symbolunderstanding.mp3',
        'Suche und klicke auf das gleiche Bild.': 'lookforcorrect.mp3',
        "Bei diesem Spiel zeigen wir dir Wörter und Bilder. Klicke das richtige Wort oder Bild an!": 'read.mp3',
        "Klicke auf die Schriftgröße, die du am besten lesen kannst. Du kannst diese hier ausprobieren. Wenn du fertig bist, klicke auf den Weiter Knopf.": 'fontsize.mp3',
        "Wie soll dein Online-Atelier aussehen? Klicke auf ein Bild zum ausprobieren. Wenn Du fertig bist, klicke auf weiter.": 'theme.mp3',
        "Welches Bild siehst Du besser? Klicke es an!": 'symbolset.mp3',
        "Du hast nun dein Online-Atelier so eingestellt, dass du es gut verwenden kannst.": 'goodbye.mp3'
      },
  ...
  jQuery(document).ready(function() {
    return _.defer(function() {
      ...
      jQuery(["" + dir + "apfel.jpg", "" + dir + "cat.jpg", "" + dir + "futter.jpg", "" + dir + "kuchen.jpg", "" + dir + "schwein.jpg", "" + dir + "auto.jpg", "" + dir + "dog.jpg", "" + dir + "haus.jpg", "" + dir + "labrador.jpg", "" + dir + "tree.jpg", "" + dir + "baby.jpg", "" + dir + "drache.jpg", "" + dir + "house.jpg", "" + dir + "lolli.jpg", "" + dir + "wasser.jpg", "" + dir + "ballon.jpg", "" + dir + "ei.jpg", "" + dir + "hund.jpg", "" + dir + "pants.gif", "" + dir + "baum.jpg", "" + dir + "erdbeere.jpg", "" + dir + "katze.jpg", "" + dir + "rose.jpg", "" + dir + "birne.jpg", "" + dir + "flugzeug.jpg", "" + dir + "kinderwagen.jpg", "" + dir + "schmetterling.jpg"]).preload();
      jQuery(["" + dir + "/mod/dogsw.jpg", "" + dir + "/mod/dog1sw.jpg", "" + dir + "/mod/dog2sw.jpg", "" + dir + "/mod/dog1.jpg", "" + dir + "/mod/dog2.jpg", "" + dir + "/mod/flugzeugsw.jpg", "" + dir + "/mod/flugzeug1sw.jpg", "" + dir + "/mod/flugzeug2sw.jpg", "" + dir + "/mod/flugzeug1.jpg", "" + dir + "/mod/flugzeug2.jpg", "" + dir + "/mod/rosesw.jpg", "" + dir + "/mod/rose1sw.jpg", "" + dir + "/mod/rose2sw.jpg", "" + dir + "/mod/rose1.jpg", "" + dir + "/mod/rose2.jpg"]).preload;
      return Capkom.console.info("dimensions:", Capkom.getDimensions());
    });
  });
  ...
  Capkom = (_ref9 = this.Capkom) != null ? _ref9 : this.Capkom = {};
  ...
  Capkom = (_ref10 = this.Capkom) != null ? _ref10 : this.Capkom = {};

  Capkom.order = ["welcome", "symbolsize", "fontsize", "theme", "read", "symbolunderstanding", "lookforcorrect", "symbolset", "goodbye"];

  Capkom.stages = {
    "welcome": {
      title: "Willkommen",
      image: "img/welcome.png",
      speech: "Hallo im Online-Atelier! Ich helfe dir damit du das Online-Atelier gut verwenden kannst. Lass uns\nzuerst spielen!",
      html: "Hallo im Online-Atelier! Ich helfe Dir damit Du das Online-Atelier gut verwenden kannst. Lass uns\nzuerst spielen!\n<div class=\"explain-area\"></div>",
      explain: function(element, done) {
        ...
        explainWeiter = function(done) {
          ...
          return weiterArea.explain({
            ...
            html: "<button class=\"nextButton demoButton\" alt=\"Weiter\" >Weiter <i class = \"icon-arrow-right\" /></button>",
        ...
        explainAudioKnopf = function(done) {
          ...
          return audioknopfArea.explain({
            read: "Wenn du nicht willst das dir der Text vorgelesen wird, dann drücke diesen Knopf. Du kannst diesen Knopf\nauch später wieder einschalten. Wenn du den Ton eingeschaltet hast ist der Knopf rot umrandet.",
            useAudio: Capkom.profile.get('useAudio'),
        ...
        return Capkom.timeout.start(2, function() {
          return explainAudioKnopf(function() {
            return Capkom.timeout.start(1, function() {
    ...
    */
    ...
    "symbolsize": {
      title: "Symbolgröße",
      speech: "Wir beginnen mit einem Spiel: Füttere den Hund. Das Füttern geht so: Klicke mit der linken Maus-Taste auf den Hund.\nWenn du es oft schaffst, ist der Hund glücklich und gesund.\n",
      condition: function(profile) {
        return profile.get("useSymbols");
      },
      image: "img/symbolsize.png",
      html: "Wir beginnen mit einem Spiel: Füttere den Hund. Das Füttern geht so: Klicke mit der linken Maus-Taste auf den Hund.\nWenn du es oft schaffst, ist der Hund glücklich und gesund.\n<button class='start'>Start</button>\n<div class='fangspiel-area'></div>\n<div class=\"explain-area\"></div>",
      _dont_startGame: function(element, done) {
      ...
      scriptOnce: function(element) {
        jQuery('.start', element).button().click(function(e) {
          return jQuery('.fangspiel-area', element).sizedetect({
            rootPrefix: 'lib/sizedetect/',
            result: function(size, details) {
              Capkom.profile.set({
              ...
              return jQuery('.nextButton', element).show();
            }
          });
        });
        if (!Capkom.profile.get('symbolsizedetectDetails')) {
          return jQuery('.nextButton', element).hide();
        }
      },
      explain: function(element, done) {
        var explainArea, explainStart;
        explainArea = jQuery('.explain-area', element);
        explainStart = function(done) {
          var startArea;
          console.info('Explaining start button');
          startArea = explainArea.append("<div class='start'></div>").find('.start');
          return startArea.explain({
    ...
    */
    ...
    "symbolunderstanding": {
      ...
      speech: "Finde heraus welche Bilder zusammengehören. Zu dem Bild in der ersten Reihe passt immer ein\nBild aus der zweiten Reihe. Klicke das richtige Bild an!",
      condition: function(profile) {
        return profile.get("useSymbols");
      },
      image: "img/symbolmatch.png",
      html: "Finde heraus welche Bilder zusammengehören. Zu dem Bild in der ersten Reihe passt immer ein\nBild aus der zweiten Reihe. Klicke das richtige Bild an!\n<button class='start'>Start</button>",
      scriptOnce: function(element) {
        jQuery('.start', element).button().click(function(e) {
          return jQuery('.play-area', element).wordmatch({
        ...
        if (!Capkom.profile.get('symbolunderstanding')) {
          return jQuery('.nextButton', element).hide();
        }
      },
      _dont_startGame: function(element, done) {
    ...
    */
    ...
    "lookforcorrect": {
      title: "Fehlersuche",
      speech: "Suche und klicke auf das gleiche Bild.",
      condition: function(profile) {
        return profile.get("useSymbols");
      },
      image: "http://i.fonts2u.com/sn/mp1_snoopy-dings_1.png",
      html: "Suche und klicke auf das gleiche Bild.<br/>\n<button class='start'>Start</button>",
      scriptOnce: function(element) {
        jQuery('.start', element).button().click(function(e) {
          return jQuery('.play-area', element).wordmatch({
            rootPrefix: 'lib/wordmatch/img/',
        ...
        if (!Capkom.profile.get('lookforcorrect')) {
          return jQuery('.nextButton', element).hide();
        }
      },
      _dont_startGame: function(element, done) {
    ...
    "read": {
      ...
      image: "img/read.png",
      speech: "Bei diesem Spiel zeigen wir dir Wörter und Bilder. Klicke das richtige Wort oder Bild an!",
      html: "Bei diesem Spiel zeigen wir dir Wörter und Bilder. Klicke das richtige Wort / Bild an!\n<br/>\n<button class='start'>Start</button>\n<button class='skip' style='font-size: 50%;'>Überspringen</button>",
      scriptOnce: function(element) {
        jQuery('.start', element).button().click(function(e) {
          ...
          return jQuery('.skip', element).hide();
        });
        jQuery('.skip', element).button().click(function(e) {
          if (!Capkom.profile.get('read')) {
            Capkom.profile.set({
              read: {
                symbol2word: {
                  correct: 0,
    ...
    "fontsize": {
      ...
      html: "Klicke auf die Schriftgröße, die du am besten lesen kannst. Du kannst diese hier ausprobieren. Wenn du fertig bist, klicke auf den Weiter Knopf.<br/><br/>\n<div class='fontsize'></div>\n<div class=\"explain-area\"></div>",
      scriptOnce: function(element) {
      ...
      explain: function(element, done) {
        var explainArea, explainZurueck;
        explainArea = jQuery('.explain-area', element);
        explainZurueck = function(done) {
          var zurueckArea;
          zurueckArea = explainArea.append("<div class='zuruck'></div>").find('.zuruck');
          return zurueckArea.explain({
            read: "Wenn du später noch einmal spielen willst, dann drücke den Zurück Knopf",
            useAudio: Capkom.profile.get('useAudio'),
            html: "<button class=\"previousButton demoButton\" alt=\"Zurück\" ><i class = \"icon-arrow-left\" /> Zurück</button>",
            script: function(element) {
              return jQuery(element).find('button').button();
            },
            after: function() {
        ...
        return Capkom.timeout.start(1, function() {
          return explainZurueck(function() {
            return done();
          });
        });
      }
    ...
    "theme": {
      ...
      speech: "Wie soll dein Online-Atelier aussehen? Klicke auf ein Bild zum ausprobieren. Wenn Du fertig bist, klicke auf weiter.",
      html: "Wie soll dein Online-Atelier aussehen? Klicke auf ein Bild zum ausprobieren. Wenn Du fertig bist, klicke auf weiter.\n<br/><br/>\n<span id='themeselector'></span>",
      scriptOnce: function(element) {
        jQuery("#themeselector", element).themeswitcher({
          width: "5em",
          buttonHeight: 30,
          onSelect: function() {
            return Capkom.profile.set({
        ...
        return jQuery('.plus', element).hide();
      }
    },
    "channels": {
    ...
    "symbolset": {
      ...
      */
      ...
      html: "Welches Bild siehst Du besser? </br> Klicke es an!\n<div class='symbolset-symbols'></div>",
      scriptOnce: function(element) {
    ...
    "goodbye": {
      ...
      html: "Du hast nun dein Online-Atelier so eingestellt, dass du es gut verwenden kannst.\n<br/><br/>\nUsertest ID: <span id='usertest-id'/><br/>\n<span id='log'></span>",
      ...
      startGame: function() {
        ...
        if (Capkom.allStagesFinished()) {
          ...
          return Capkom.saveTestData(Capkom.profile);
        }
      }
    }
  };

  Capkom.getTestDataId = function(cb) {
    var db;
    db = jQuery.couch.db('capkom-testresults');
    return db.info({
      success: function(data) {
        Capkom.console.info('view data', data.doc_count);
        return cb("UT-" + data.doc_count);
      }
    });
  };

  Capkom.saveTestData = function(doc, cb) {
    var db, logEl, save, saveErr;
    logEl = jQuery('#log');
    saveErr = function(msg) {
      return logEl.html(msg + " Bitte ein Mail mit dieser Fehlermeldung an szaby.gruenwald@salzburgresearch.at zu schicken.");
    };
    if (!jQuery.couch) {
    ...
    db.info({
      success: function(data) {
        return Capkom.console.info('db info', data);
      },
      error: function(jqXhr, message) {
        Capkom.console.error("couchdb info error: " + message);
        return saveErr("Server konnte nicht nicht erreicht werden. " + message);
      }
    });
    save = function() {
      return db.saveDoc(doc.toJSON(), {
        success: function(res) {
          var returnUri;
          if (res.ok) {
            ...
            if (returnUri) {
              ...
              return setTimeout(function() {
                return window.location = encodeURIComponent(returnUri);
              }, 2000);
            } else {
              return console.info("No returnuri= URL param, no forwarding.");
            }
          } else {
            return Capkom.console.info('Error saving Usertest document', res);
          }
        },
        error: function(jqXhr, message) {
          Capkom.console.error("saveDoc error: " + message);
          return saveErr("Die Testdaten konnten nicht gespeichert werden: " + message);
        }
      });
    };
    if (doc.get('_id')) {
      ...
      return Capkom.getTestDataId(function(id) {
        doc.set({
          '_id': id
        });
        return save();
  ...
  Capkom.allStagesFinished = function() {
    var logEl, missing;
    missing = [];
    if (!Capkom.profile.get('symbolsizedetectDetails')) {
  ...
  */
  ...
  Capkom.getStages = function() {
    var i, res, stage, stagename, urlhidden, _ref11;
    res = (function() {
      var _ref11, _results;
      _ref11 = Capkom.order;
      _results = [];
    ...
    */
    ...
    res = _(res).filter(function(stage) {
      if ((typeof stage.condition === "function" ? stage.condition(Capkom.profile) : void 0) !== false) {
        return true;
      }
    });
    urlhidden = ((_ref11 = Capkom.getUrlParameter('hidestages') || null) != null ? _ref11.split(',') : void 0) || [];
    return res = _(res).filter(function(stage) {
      if (_.indexOf(urlhidden, stage.name) === -1) {
        return true;
      }
    });
  };
  ...
  Capkom.showStages = function(el) {
    var an, anchor, anchorName, anchorNames, anchors, i, stage, stageNames, stages, _i, _j, _k, _len, _len1, _ref11, _ref12, _results, _results1;
    if (Capkom.uiLoaded) {
      ...
      */
      ...
      _ref12 = (function() {
        _results = [];
        for (var _j = 0, _ref11 = anchors.length - 1; 0 <= _ref11 ? _j <= _ref11 : _j >= _ref11; 0 <= _ref11 ? _j++ : _j--){ _results.push(_j); }
        return _results;
      }).apply(this).reverse();
  ...
  Capkom = (_ref11 = this.Capkom) != null ? _ref11 : this.Capkom = {};
  ...
  Capkom.initNav = function() {
    var i, stage, _ref12, _renderStageTitle;
    ...
    jQuery(".stages").tabs({
      show: function(event, ui) {
        ...
        autoForward = function(stage, panel, done) {
          if (Capkom.nonClickMode()) {
            Capkom.timeout.start(1, function() {
              return Capkom.clickNext();
            });
          }
          return _.defer(function() {
        ...
        return _.defer(function() {
          return autoread(newStage, ui.panel, [autoExplain, autoGameStart]);
        });
      }
    ...
    Capkom.Router = Backbone.Router.extend({
      ...
      stage: function(stage) {
        return jQuery(".stages").tabs('option', 'active', stage);
      }
    });
  ...
  Capkom.getUrlParameter = function(name) {
