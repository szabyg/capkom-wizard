  ...
  */
  ...
  Capkom.stages = {
    ...
    */
    ...
    "symbolsize": {
      title: "Symbolgröße",
      speech: "Wir beginnen mit einem Spiel: Füttere den Hund. Ziehe die Futterdose auf das Bild von dem Hund.\nWenn du es oft schaffst, ist der Hund glücklich und gesund.",
      condition: function(profile) {
        return profile.get("useSymbols");
      },
      image: "img/symbolsize.png",
      html: "Wir beginnen mit einem Spiel: Füttere den Hund. Ziehe die Futterdose auf das Bild von dem Hund.\nWenn du es oft schaffst, ist der Hund glücklich und gesund.\n<button class='start'>Start</button>\n<div class='fangspiel-area'></div>",
      /*
  ...
  */
  ...
  Capkom.initNav = function() {
    ...
    Capkom.Router = Backbone.Router.extend({
      ...
      initialize: function() {
        var i, stage, _ref10, _results;
        _ref10 = Capkom.getStages();
        _results = [];
        for (i in _ref10) {
          stage = _ref10[i];
          /*
