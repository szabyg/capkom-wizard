  ...
  */
  ...
  Capkom.stages = {
    "welcome": {
      ...
      speech: "Hallo im Online-Atelier! Wir helfen dir damit du das Online-Atelier gut verwenden kannst. Lass uns\nzuerst spielen!",
      html: "Hallo im Online-Atelier! Wir helfen dir damit du das Online-Atelier gut verwenden kannst. Lass uns\nzuerst spielen!\n<div class=\"explain-area\"></div>",
    ...
    */
    ...
    "read": {
      ...
      speech: "Bei diesem Spiel zeigen wir dir Wörter und Bilder. Wähle das passende Wort oder Bild aus.",
      html: "Bei diesem Spiel zeigen wir dir Wörter und Bilder. Wähle das passende Wort oder Bild aus.\n<br/>\n<button class='start'>Start</button>",
      scriptOnce: function(element) {
        return jQuery('.start', element).button().click(function(e) {
          jQuery('.play-area', element).wordmatch({
            rootPrefix: 'lib/wordmatch/img/',
    ...
    "theme": {
      title: "Aussehen",
      image: "http://www.balloonmaniacs.com/images/snoopygraduateballoon.jpg",
      speech: "Wie soll dein Online-Atelier aussehen? Hier siehst du mehrere Bilder und du kannst sie gleich\nausprobieren. Dann drücke auf den Knopf \"Weiter\".",
      html: "Wie soll dein Online-Atelier aussehen? Hier siehst du mehrere Bilder und du kannst sie gleich\nausprobieren. Dann drücke auf den Knopf \"Weiter\".\n<br/><br/>\n<span id='themeselector'></span>",
      scriptOnce: function(element) {
  ...
  Capkom.saveTestData = function(doc) {
    ...
    db.info({
      success: function(data) {
        ...
        return console.info('couch info', data);
      }
    });
    save = function() {
      return db.saveDoc(doc.toJSON(), {
        success: function(res) {
          if (res.ok) {
            ...
            return console.info('Error saving Usertest document', res);
          }
        }
      });
    };
